[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.4073215.svg)](https://doi.org/10.5281/zenodo.4073215)
...
[Wout has since remodelled the repository](https://github.com/WoutDLN/pizzaParty/releases/tag/v2.0.0) in view of teaching his Library and Information Science students the basics of git and GitHub in the Digitizing Cultural Heritage Materials (DCHM) course at the [University of Borås](https://www.hb.se/) (Sweden), where he currently works as a Senior Lecturer. Since then, the course has changed slightly, and is now called 'Digitalisering för bevarande och tillgänglighet' [digitisation for preservation and accessibility] – although the GitHub sessions themselves have remained the same. The repository is currently also being used in another one of Wout's classes at the University of Borås: Datalogical Thinking. Many thanks to my patient students, in 2022, 2023, 2024, 2025 and the spring of 2026!

Special thanks go to the students of the DCHM course who took part in the residential week of 2022 for being Wout's guinea pigs when he first tried out teaching this workshop.
